...
export class Story {
  ...
  static parseCharacterStyleRange(element: Element, context: IDMLBackingStoryContext): CharacterStyleRange {
    ...
    const localCharacterStyleInput: CharacterStyleInput = Object.fromEntries(Object.entries({
      ...
      underlineWeight: ensureNumber(props.UnderlineWeight),
      underlineOffset: ensureNumber(props.UnderlineOffset),
      underlineColor: props.UnderlineColor ? context.idml.getColorById(props.UnderlineColor)?.toColorInput() : undefined,
