...
export namespace Elements {
  ...
  export type Text = Common & {
    name: 'text';
    properties: {
      'v-transform-origin'?: Value; 'v-show'?: Value; visible: Value; textMode: Value; text: Value; richText: Value; autoLinebreaks: Value; autoLinebreaksAllowBreakChars: Value; bounding: Value; uppercase: Value; pos: Value; x: Value; y: Value; width: Value; height: Value; fontFamily: Value; fontSize: Value; fontWeight: Value; fontStyle: Value; lineHeight: Value; letterSpacing: Value; textDecoration?: Value; linebreakingAlgorithm?: Value; hyphenation?: Value; hyphenationLanguage?: Value; fontStretch: Value; textAlign: Value; justifyText: Value; rotateLine: Value; rotateChar: Value; lineSkewX: Value; lineSkewY: Value; fill: Value; stroke: Value; strokeWidth: Value; strokeDasharray: Value; strokeDashoffset: Value; strokeAlignment: Value; opacity: Value; type: Value; features: Value; textOnPathInnerGlyphAnchor: Value; textOnPathBaseline: Value; textOnPathDelta: Value; textOnPathOffset: Value;
    };
  };
